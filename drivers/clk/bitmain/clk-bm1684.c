...
static const struct bm_gate_clock gate_clks[] = {
	...
	{ GATE_CLK_TPU_DIV0, "clk_gate_tpu_div0", "tpll_clock",
		CLK_IGNORE_UNUSED | CLK_IS_CRITICAL, 0x820, 18, 0 },
	{ GATE_CLK_AXI_VDE_WAVE_DIV0, "clk_gate_axi_vde_wave_div0", "fpll_clock",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED | CLK_IS_CRITICAL, 0x820, 21, 0 },
	{ GATE_CLK_AXI10_DIV0, "clk_gate_axi10_div0", "fpll_clock",
		CLK_IGNORE_UNUSED | CLK_IS_CRITICAL, 0x820, 23, 0 },
	...
	{ GATE_CLK_TPU_DIV1, "clk_gate_tpu_div1", "fpll_clock",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED | CLK_IS_CRITICAL, 0x820, 19, 0 },
	{ GATE_CLK_AXI_VDE_WAVE_DIV1, "clk_gate_axi_vde_wave_div1",
		"vpll_clock", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED | CLK_IS_CRITICAL
		, 0x820, 20, 0 },
	{ GATE_CLK_AXI10_DIV1, "clk_gate_axi10_div1", "vpll_clock",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED | CLK_IS_CRITICAL, 0x820, 22, 0 },
